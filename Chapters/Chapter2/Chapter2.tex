...
como Erlang \todonotes{cita erlang}.
...
Un sistema con modelo de actores\todo{aca en este punto podemos incluir el
  manifiesto Reactivo (?)} puede aydar ya que un actor como se describio en [n]
