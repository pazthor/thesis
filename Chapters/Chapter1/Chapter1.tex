...
\label{Chapter1}
\lhead{Cap\'itulo1. \emph{Caminatas aleatorias}} % Write in your own chapter title to set the page header
...
Movimiento browniano, vuelo de levy,\ldots  \todo{agregar } entre otros. Esta
investigacion solo se centrara en las estrategias que usa \emph{los algoritmos
  que considera el doctor Carlos en su phd } \todo{cambiar frase}\\
...
\todo{ref: introduction to probabilty, charles M. Grinstead }
